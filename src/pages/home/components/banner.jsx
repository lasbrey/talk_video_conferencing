...
function Banner() {
  return (
    <div className="flex flex-col justify-center items-center bg-slate-900 text-white lg:p-20 p-4 my-10">
      <span className="lg:text-5xl text-2xl font-bold ">Ready to get started?</span>
